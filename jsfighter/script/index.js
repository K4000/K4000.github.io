...
const MAX_STAT = 999; // The highest any stat can go
const MIN_DODGE = 4; // The target the player needs to hit to
const DODGE_MULTI = 0.5; // The multiplier of damage that is reduced by a dodge
...
function startup() {
    ...
    Player0 = new Fighter('RedPlayer1', P0CHARA);
    ...
    graphics.innerHTML += '<img width= "64" id="' + P1CHARA + 'IMG" class="fighterIMG" src="img/' + P1CHARA + '_idle.png" alt="' + P1NAME + '">';
    // Create bars
...
function changeClass() {
  let classBox = document.getElementById("FighterClass")
if (classBox.value == "Sam") {
  Player1 = new Sam('Sam', P1CHARA);
} else if (classBox.value == "Crash"){
Player1 = new Crash('Crash', P1CHARA);
} else if (classBox.value == "Todd"){
Player1 = new Todd('Todd', P1CHARA);
}
classBox.style.display = "none";
let namebox = document.getElementById("P0NAME")
